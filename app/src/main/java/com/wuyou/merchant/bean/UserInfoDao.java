...
import com.wuyou.merchant.bean.UserInfo.CatConverter;
...
public class UserInfoDao extends AbstractDao<UserInfo, Long> {
    ...
    public static class Properties {
        ...
        public final static Property Official = new Property(12, String.class, "official", false, "OFFICIAL");
    }

    private final CatConverter officialConverter = new CatConverter();
    ...
    protected final void bindValues(DatabaseStatement stmt, UserInfo entity) {
        ...
        OfficialEntity official = entity.getOfficial();
        if (official != null) {
            stmt.bindString(13, officialConverter.convertToDatabaseValue(official));
        }
    }
    ...
    public UserInfo readEntity(Cursor cursor, int offset) {
        UserInfo entity = new UserInfo( //
            ...
            cursor.isNull(offset + 12) ? null : officialConverter.convertToEntityProperty(cursor.getString(offset + 12)) // official
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, UserInfo entity, int offset) {
        ...
        entity.setOfficial(cursor.isNull(offset + 12) ? null : officialConverter.convertToEntityProperty(cursor.getString(offset + 12)));
     }
