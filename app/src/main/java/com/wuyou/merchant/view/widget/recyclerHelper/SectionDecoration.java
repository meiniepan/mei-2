package com.wuyou.merchant.view.widget.recyclerHelper;
...
import com.wuyou.merchant.bean.entity.AddressEntity;

import java.util.List;

/**
 * Created by Solang on 2018/4/19.
 */
...
public class SectionDecoration extends RecyclerView.ItemDecoration {
    ...
    public SectionDecoration(List<AddressEntity> dataList, Context context, DecorationCallback decorationCallback) {
        Resources res = context.getResources();
        this.dataList = dataList;
        this.callback = decorationCallback;
        //设置悬浮栏的画笔---paint
        paint = new Paint();
        paint.setColor(res.getColor(R.color.main_blue));

        //设置悬浮栏中文本的画笔
        textPaint = new TextPaint();
        textPaint.setAntiAlias(true);
        textPaint.setTextSize(DensityUtils.dip2px(context, 14));
        ...
        //决定文本的显示位置等
        alignBottom = res.getDimensionPixelSize(R.dimen.activity_horizontal_margin);
    }
